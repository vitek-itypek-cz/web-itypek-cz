...
const Sidebar: FC = () => {
  ...
  return (
    <aside className="hidden lg:flex flex-col fixed left-0 top-0 h-full bg-white shadow-lg w-64 z-50">
      ...
      <nav className="flex flex-col flex-grow px-6 py-8">
        {menuLinks.map((link, index) => (
          <a
            key={index}
            href={link.href}
            className={`py-3 text-lg transition-colors font-medium ${
      ...
      <div className="px-6 py-6">
        <p className="text-sm font-semibold mb-3">Kontaktujte nás</p>
